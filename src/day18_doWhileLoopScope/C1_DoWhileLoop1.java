...
public class C1_DoWhileLoop1 {
	...
	public static void main(String[] args) {
		...
		// kullanici dogru giris yaptiginda "well done" 
		//ve sayilarin carpimini yazdirin
		...
		while (!(sayi1>0 && sayi2>0)) { // !(sayi1>0 && sayi2>0),(sayi1<=0 || sayi2<=0)
			sayi1 = scan.nextInt();
			sayi2 = scan.nextInt();
		if (sayi1>0 && sayi2>0) {
