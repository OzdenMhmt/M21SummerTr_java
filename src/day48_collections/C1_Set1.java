...
public class C1_Set1 {
	...
	public static void main(String[] args) {
		Set<String> set1 = new HashSet<>(); // set-->interface contructur'u yok, HashSet class
		...
		System.out.println(set1);
		// Set'de onemli olan ozellik No duplication ve elemanin kumede var olup
		// olmamasidir
		// Siralama Set icin onemli degildir
		// Set icin elemanlari girdigimiz sirada verir veya elemanlari natural siralama
		// ile verir
