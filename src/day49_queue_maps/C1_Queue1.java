package day49_queue_maps;

import java.util.LinkedList;
import java.util.PriorityQueue;
import java.util.Queue;

public class C1_Queue1 {
	...
	public static void main(String[] args) {
		...
		// Queue'nun yapisi geregi FIFO kurali gecerlidir.First in-First out
		...
		//Queue'en aradan bir sey cikar veya ekle methodu yok.
		//remove veya add'da index gozukmuyor
		//Kuyruktan cikis yok.ama obje silebiliyor
		...
		//k2.remove();//bos bir queue'dan remove() ile silmek istersek exception verir
		
		//System.out.println(k2.element());// queue bossa exc. firlatir(ilk elamnai ister)
	}
}
